...
public final class Shakespeare {
	 ...
	 * Our data, part 1.
	 */
	public static final String[] TITLES_LIGHT = { "首页", "站点", "主题", "周刊", "我的"};
	// public static final String[] TITLES_NIGHT =
	// {
	// "文章首页",
	// "我的收藏",
	// "我的待读",
	...
	// "相关设置"
	// };
	public static final int[] IMAGE_TITLES_LIGHT = { R.drawable.left_article_selected, R.drawable.left_cang,
			R.drawable.drawer_ic_site_myread, R.drawable.left_mag, R.drawable.left_my

	};
	// public static final int[] IMAGE_TITLES_NIGHT =
	// {
	// R.drawable.left_article_selected,
	// R.drawable.left_cang,
	// R.drawable.drawer_ic_site_myread,
	// R.drawable.left_mag,
	// R.drawable.drawer_ic_offline_download,
	// R.drawable.left_night_day,
	// R.drawable.drawer_ic_setting
	//
	// };
	 ...
	 * Our data, part 2.
	 */
	public static final String[] DIALOGUE = { "So shaken as we are, so wan with care,"
			+ "Find we a time for frighted peace to pant," + "And breathe short-winded accents of new broils"
			+ "To be commenced in strands afar remote." + "No more the thirsty entrance of this soil"
			+ "Shall daub her lips with her own children's blood;" + "Nor more shall trenching war channel her fields,"
